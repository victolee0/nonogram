...
from utils import extract_hint_from_blocks, check_hint_match
...
def main():
    ...
    if args.pretrain_bc and episodes_collected == 0:
        ...
        for ref in ready_refs:
            ...
            if episodes_collected - last_log_ep >= args.log_freq:
                ...
                print(f"[ep {episodes_collected:6d}/{args.num_episodes}] "
                      f"success={avg_s:.3f}  p_loss={avg_p_loss:.4f}  v_loss={avg_v_loss:.4f}  lql_loss={avg_lql_loss:.4f}  "
